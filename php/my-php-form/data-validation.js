function validateForm() {
	...
	if (townCity.value.length == 0){//start if 
	//if fname value has a length is 0 do this 
	...
	if (postcode.value.length == 0){//start if 
	//if fname value has a length is 0 do this 
	...
	if ((ferror == 1) || (lerror == 1) || (aerror == 1) || (houseerror == 1) || (streeterror == 1) || (townerror == 1) || (counterror == 1) || (posterror == 1)) {
